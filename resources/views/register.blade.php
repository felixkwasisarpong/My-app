            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="register">
                        ...
                        <form action="{{route('registerroute')}}" id="register-form" role="form" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control datepicker " id="dob"
                                               name="date_of_birth"
                                               placeholder="DOB" value="{{old('date_of_birth')}}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="tel" class="form-control " id="phone" name="phone"
                                               placeholder="Phone name" value="{{old('phone')}}" required>
                                        @if($errors->has('phone'))
...
@section('scripts')
    <script>
        ...
        $('#register-form').submit(function(e) {
            ...
            let flag = $('.iti__selected-flag').attr('title');

            let code = flag ? flag.split(':')[1].trim() : '';
